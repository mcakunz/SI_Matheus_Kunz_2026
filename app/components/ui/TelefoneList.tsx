...
import { TipoOpcao } from "./EmailList"
...
export function TelefoneList({
    ...
    const tipoDefault = tiposTelefone[0]?.value ?? ''
    ...
    return (
        <div className="pt-1">
            <div className="flex items-center justify-between mb-3">
                ...
                <button
                    type="button"
                    onClick={() => append({ telefone: '', tipo: tipoDefault, principal: fields.length === 0, ativo: true })}
